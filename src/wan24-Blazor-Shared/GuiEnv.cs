namespace wan24.Blazor
{
    ...
    public static class GuiEnv
    {
        ...
        /// Type
        /// </summary>
        public static GuiTypes AppType { get; internal set; }

        /// <summary>
        /// Is a .NET MAUI app?
        /// </summary>
        public static bool IsMAUI => AppType == GuiTypes.MAUI;

        /// <summary>
        /// Is a Blazor WebAssembly app?
        /// </summary>
        public static bool IsWASM => AppType == GuiTypes.WASM;
        ...
        /// </summary>
        public static bool IsLocalApp => AppType == GuiTypes.MAUI;
