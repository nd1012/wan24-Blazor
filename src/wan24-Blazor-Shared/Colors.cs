...
{
    /// <summary>
    /// Colors (Bootstrap CSS class names)
    /// </summary>
    public static class Colors
    {
        ...
        {
            /// <summary>
            /// All HTML colors (key is the HTML color name)
            /// </summary>
            private static readonly FrozenDictionary<string, CssRgbA> All;
            /// <summary>
            /// IndianRed
            /// </summary>
            ...
            /// White
            /// </summary>
            public static readonly CssRgbA White = new("White", RgbA.White);
            /// <summary>
            /// Snow
            /// </summary>
            ...
            /// Black
            /// </summary>
            public static readonly CssRgbA Black = new("Black", RgbA.Black);
            ...
            static HTML()
            {
                FieldInfo[] fields = typeof(HTML).GetFields();
                int len = fields.Length;
                Dictionary<string, CssRgbA> colors = new(len);
                for (int i = 0; i < len; colors[fields[i].Name] = (CssRgbA)fields[i].GetValue(obj: null)!, i++) ;
                All = colors.ToFrozenDictionary();
            }
            ...
            /// <summary>
            /// Get a HTML color by its name (case is ignored)
            /// </summary>
            ...
            public static CssRgbA GetByName(string name)
            {
                ...
                return key is null ? throw new ArgumentException("Invalid HTML color name", nameof(name)) : All[key];
            }
