...
namespace wan24.Blazor
{
    ...
    public static class Startup
    {
        ...
        public static void Start(in GuiTypes guiType, in BuildTypes build)
        {
        ...
        public static async Task StartAsync(GuiTypes guiType, BuildTypes build, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="guiType">GUI type</param>
        /// <param name="build">Build type</param>
        private static void SyncStart(in GuiTypes guiType, in BuildTypes build)
        {
            ...
            ENV.IsBrowserApp = guiType == GuiTypes.WASM;
