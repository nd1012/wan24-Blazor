...
namespace wan24.Blazor.Parameters
{
    ...
    /// </summary>
    public record class BoxParametersExt : BoxParameters, IBoxParametersExt
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public BoxParametersExt() : base() { }

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="original">Original</param>
        public BoxParametersExt(in IBoxParametersExt original) : base(original) => ChildContent = original.ChildContent;
