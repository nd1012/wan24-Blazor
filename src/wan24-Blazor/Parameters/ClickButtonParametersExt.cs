...
{
    /// <summary>
    /// Extended click button parameters
    /// </summary>
    public record class ClickButtonParametersExt : ClickButtonParameters, IClickButtonParametersExt
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public ClickButtonParametersExt() : base() { }

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="original">Original</param>
        public ClickButtonParametersExt(in IClickButtonParametersExt original) : base(original)
        {
        ...
        /// Singleton instance
        /// </summary>
        public static ClickButtonParametersExt Instance { get; set; } = new();
