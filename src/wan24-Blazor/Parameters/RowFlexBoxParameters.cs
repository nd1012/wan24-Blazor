...
{
    /// <summary>
    /// Extended row flex box parameters
    /// </summary>
    public record class RowFlexBoxParametersExt : RowFlexBoxParameters, IRowFlexBoxParametersExt
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public RowFlexBoxParametersExt() : base() { }

        /// <summary>
        /// 
        /// </summary>
        /// <param name="original"></param>
        public RowFlexBoxParametersExt(in IRowFlexBoxParametersExt original) : base(original) => ChildContent = original.ChildContent;

        /// <summary>
        /// Singleton instance
        /// </summary>
        public static RowFlexBoxParametersExt Instance { get; set; } = new();
