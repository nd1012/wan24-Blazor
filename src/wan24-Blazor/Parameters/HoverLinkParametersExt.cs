...
{
    /// <summary>
    /// Extended hover link parameters
    /// </summary>
    public record class HoverLinkParametersExt : HoverLinkParameters, IHoverLinkParametersExt
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public HoverLinkParametersExt() : base() { }

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="original">Original</param>
        public HoverLinkParametersExt(in IHoverLinkParametersExt original) : base(original)
        {
        ...
        /// Singleton instance
        /// </summary>
        public static LinkParametersExt Instance { get; set; } = new();
