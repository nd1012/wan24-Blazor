...
{
    /// <summary>
    /// Extended box parameters
    /// </summary>
    public record class ChapterParametersExt : ChapterParameters, IChapterParametersExt
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public ChapterParametersExt() : base() { }

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="original">Original</param>
        public ChapterParametersExt(in IChapterParametersExt original) : base(original) => ChildContent = original.ChildContent;

        /// <summary>
        /// Singleton instance
        /// </summary>
        public static BoxParametersExt Instance { get; set; } = new();
