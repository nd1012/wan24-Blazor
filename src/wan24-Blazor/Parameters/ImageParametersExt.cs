...
namespace wan24.Blazor.Parameters
{
    ...
    /// </summary>
    public record class ImageParametersExt : ImageParameters, IImageParametersExt
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public ImageParametersExt() : base() { }

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="original">Original</param>
        public ImageParametersExt(in IImageParametersExt original) : base(original) => ChildContent = original.ChildContent;

        /// <summary>
        /// Singleton instance
        /// </summary>
        public static ImageParametersExt Instance { get; set; } = new();
