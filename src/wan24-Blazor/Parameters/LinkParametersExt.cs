...
namespace wan24.Blazor.Parameters
{
    ...
    /// </summary>
    public record class LinkParametersExt : LinkParameters, ILinkParametersExt
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public LinkParametersExt() : base() { }

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="original">Original</param>
        public LinkParametersExt(in ILinkParametersExt original) : base(original)
        {
