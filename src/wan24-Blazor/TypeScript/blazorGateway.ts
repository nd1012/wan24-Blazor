...
module blazorGateway {
    ...
    class AbstractDomElement {
         ...
         * Assembly name
         */
        static readonly ASSEMBLY = 'wan24Blazor.dll';
        /**
         ...
         */
        get parentId(): string {
            return this.#_element.parentElement.id;
        }
        ...
        constructor(element: Element) {
            ...
            this.#_element = ensureId(element.parentElement);
    ...
    export function getElementById(id: string): string {
        ...
        return element ? new AbstractDomElement(element).toJson() : null;
    }
     ...
     */
    export function getElementsByTagName(tag: string): Array<string> {
     ...
     * @returns DOM elements JSON
     */
    export function querySelectorAll(selector: string): Array<string> {
